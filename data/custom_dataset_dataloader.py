...
class CustomDatasetDataLoader(object):
    ...
    def __init__(self, dataset_type, train, batch_size,
		...
		data_paths=None, data_labels=None, num_workers=0, **kwargs):

        self.train = train
        self.dataset = getattr(single_dataset, dataset_type)(root=dataset_root)
        self.dataset.initialize(root=dataset_root,
                                transform=transform, classnames=classnames,
                                data_paths=data_paths, data_labels=data_labels, **kwargs)
