...
__C.TRAIN.BASE_LR = 0.000003#0.00001 #0.0000003 #0.000003
__C.TRAIN.MOMENTUM = 0.9
__C.TRAIN.LR_MULT = 10.0
__C.TRAIN.OPTIMIZER = 'Adam'
__C.TRAIN.WEIGHT_DECAY = 0.00001
__C.TRAIN.LR_SCHEDULE = ''
__C.TRAIN.LR_UPDATE_LOOP = 20
__C.TRAIN.FIRST_MAX_LOOP = 50
__C.TRAIN.MAX_LOOP = 20
...
__C.EXP = edict()
__C.EXP.LR_DECAY_RATE = 0.01
__C.EXP.LR_DECAY_STEP = 300

# +
# AADA
__C.AADA = edict()
__C.AADA.K_CLF = 1
__C.AADA.K_CRITIC = 10
__C.AADA.DELTA = 10
__C.AADA.LAMBDA = 0.0001
__C.AADA.MAX_EPOCH = 30
...
# MME
__C.MME = edict()
__C.MME.FIRST_MAX_EPOCH = 20#50
__C.MME.MAX_EPOCH = 20
__C.MME.temp = 0.05
__C.MME.lambda_h = 0.1
__C.MME.lambda_s = 0.1
__C.MME.lambda_t = 1.0
# -
...
# CAN
__C.CAN = edict()
__C.CAN.MAX_EPOCH = 15
__C.CAN.PRE_TRAIN_EPOCH = 5


# Finetune
__C.FINETUNE = edict()
__C.FINETUNE.STRATEGY =  'Badge' #'MaxDistanceSampling' #'MinDistanceSampling'# 'MarginSampling' 'ClusterMarginSampling'
__C.FINETUNE.NUM_QUERY_PERCENT = None
__C.FINETUNE.NUM_QUERY = 30#500 #18
__C.FINETUNE.NUM_ROUND = 10#20 #10s
__C.FINETUNE.N_EPOCH = 1
__C.FINETUNE.LR = 0.01
__C.FINETUNE.MOMENTUM = 0.5
__C.FINETUNE.TRAIN_BATCH_SIZE = 64
__C.FINETUNE.TRAIN_NUM_WORKERS= 1
__C.FINETUNE.TEST_BATCH_SIZE = 100
__C.FINETUNE.TEST_NUM_WORKERS = 1
__C.FINETUNE.THRESHOLD = 1
